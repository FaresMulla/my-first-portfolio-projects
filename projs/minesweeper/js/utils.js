...
function checkSafty() {
  ...
  // @CR - Use the function 'getEmptyCells' is the preferd strategy here. In some cases, the loop you wrote here will run many times before finding a safe cell.
  for (var i = 0; i < 5; i++) {
